<template>
	<div class="mb-">
		<button
			v-if="!hasToken"
			class="btn outline-none rounded-[10px] w-[130px] lg:w-[120px] px-[10px] py-[6px] lg:py-[10px] lg:px-[6px] text-xs font-normal lg:mt-[10px] bg-transparent"
		...
		<div v-else class="settings dropdown-container mt-[18px]">
			...
			>
				...
				<ul v-if="isProfileSetting" class="dropdown-options w-[130px]">
					<div class="btns flex items-center p-[10px]" @click="goSettings()">
