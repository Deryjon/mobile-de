<template>
  <button
	v-if="!hasToken"
    class="btn bg-transparent dropdown-input mark_input mark-select w-[200px] lg:w-[150px] xl:w-[150px] h-[50px] outline-none bg-white rounded-[10px] py-[15px] px-[30px] font-normal pr-[30px] text-[10px] lg:text-[11px]"
