<template>
  <div class="tabs">
      ...
      <li :class="{ 'active': activeTab === 'register' }" @click="activeTab = 'register'">Register</li>
    </ul>
    <div class="tab-1" v-if="activeTab === 'login'">
      <v-sheet
        width="600"
        height="700"
        class="mx-auto shadow-md mt-[50px] px-[25px] rounded-md"
      >
        <div class="register">
          <h2 class="text-4xl font-bold text-purple-600 text-center mb-4">
            Register
          </h2>
        </div>
        ...
        <v-form @submit.prevent="signUp">
          ...
          <button
            type="submit"
            class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-purple-600 rounded-md hover:bg-purple-600 focus:outline-none focus:bg-purple-600 mt-[10px]"
          >
            Register
          </button>
        </v-form>
        <div class="flex items-center">
          ...
          <p
            class="text-purple-600 hover:underline text-sm cursor-pointer ml-1 mt-3 text-center"
            @click="goLog"
          >
            Login
          </p>
        ...
        <div
          class="apps flex justify-between flex-col mx-auto w-[500px] mt-[20px]"
        >
          <div
            class="google cursor-pointer flex gap-3 mx-auto mb-4 hover:border-b-purple-500"
          >
            <svg viewBox="0 0 32 32" class="w-5 h-5 fill-current">
              <path
          ...
          <div
            class="github cursor-pointer flex gap-3 mx-auto mb-4 hover:border-b-purple-500"
          >
            <svg viewBox="0 0 32 32" class="w-5 h-5 fill-current">
              <path
          ...
          <div
            class="twitter cursor-pointer flex gap-3 mx-auto hover:border-b-purple-500"
          >
            <svg viewBox="0 0 32 32" class="w-5 h-5 fill-current">
              <path
    ...
    <div class="tab-2" v-else-if="activeTab === 'register'">
			<v-sheet
    width="600"
    height="550"
