  ...
  <v-container class="max-w-[1140px] md:flex gap-[5px] justify-between pl-0 ml-[4px] relative" v-else>
    <div class=" relative md:hidden  h-[230px] lg:h-[500px] w-full lg:w-[700px]">
      ...
      <div class="slider h-[250px] sm:h-[300px]   w-full lg:h-[400px] lg:w-[600px]">
        <img v-for="(image, index) in images" :key="index" :src="image"
          ...
          class="h-[250px] sm:h-[300px] lg:h-[400px] bor w-full lg:w-[600px] opacity-0 absolute  duration-500 object-cover" />
    ...
    <div class="left flex flex-col gap-[20px] w-full md:max-w-[600px] lg:max-w-[700px]  rounded-[4px] mt-[10px]">
      <div class=" relative hidden md:block  h-[230px] lg:h-[400px] w-full lg:max-w-[700px]">
        ...
        <div class="slider h-[250px] sm:h-[300px]   w-full lg:h-[400px] lg:max-w-[700px]">
          <img v-for="(image, index) in images" :key="index" :src="image"
            :class="{ 'slider-item': true, active: activeIndex === index }"
            class="h-[250px] sm:h-[300px] lg:h-[400px] w-full bor lg:max-w-[700px] opacity-0 absolute  duration-500 object-cover" />
      ...
      <div class="basic-data bor flex flex-wrap gap-[5px] justify-between lg:h-[180px] p-[20px] mt-[40px]">
        <div class="mileage flex w-[186px] gap-[5px]">
          ...
          <div class="kilomet">
            <p class="text-[12px]">{{ $t("message.single_page.mileage") }}</p>
        ...
        <div class="registration flex w-[186px] gap-[5px]">
          ...
          <div class="kilomet">
            <p class="text-[12px]">{{ $t("message.single_page.first") }}</p>
        ...
        <div class="power flex w-[186px] gap-[5px]">
          ...
          <div class="kilomet">
            <p class="text-[12px]">{{ $t("message.single_page.power") }}</p>
        ...
        <div class="power flex w-[186px]">
          ...
          <div class="kilomet">
            <p class="text-[12px]">{{ $t("message.single_page.gearbox") }}</p>
        ...
        <div class="power flex w-[186px] gap-[5px]">
          ...
          <div class="kilomet">
            ...
            <p class="text-[12px] font-medium lg:font-bold">{{ motorcycle.motorcycle_number_owners }}</p>
          </div>
        </div>
        <div class="power flex w-[186px] gap-[5px]">
          <svg class="SvgIcon__1H1VO" width="40" height="40" viewBox="0 0 40 40" focusable="false" aria-hidden="true"
          ...
          <div class="kilomet">
            ...
            <p class="text-[12px] font-medium lg:font-bold">{{ motorcycle.motorcycle_fuel_type }}</p>
          </div>
        </div>
      </div>
      <div class="technical-data bor p-[20px]">
        ...
        <div class="td-box mt-[20px] flex flex-col gap-[10px] lg:gap-[20px]">
          ...
          <div class="mileage flex justify-between">
            ...
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ motorcycle.motorcycle_mileage }} km</p>
          </div>
          <div class="cubic flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">{{ $t("message.single_page.cubcap") }}</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">
          ...
          <div class="power flex justify-between">
            ...
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ motorcycle.motorcycle_fuel_type }}</p>
          </div>
          <div class="availability flex justify-between">
            ...
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ motorcycle.motorcycle_transmission }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">
              {{ $t("message.single_page.first") }}
            </p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ motorcycle.motorcycle_firt_date_year }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">
              {{ $t("message.single_page.programme") }}
            </p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ motorcycle.motorcycle_approved_used_programme }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">{{ $t("message.single_page.condition") }}</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ motorcycle.motorcycle_condition }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">{{ $t("message.single_page.color") }}</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ motorcycle.motorcycle_exterior_colour }}</p>
          </div>
        </div>
      </div>
      <div class="features bor p-[20px]">
        ...
        <div class="flex flex-wrap  mt-[20px] gap-[20px] justify-between text-[11px] lg:text-[14px] font-semibold">
          ...
          <div v-for="item in motorcycle.extras" class="flex justify-between w-[297px]">
            <p class="">{{ item }} </p>
            <svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512">
              <path
                d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" />
    ...
    <div
      ...
      <div class="motorcycle-motorcyclee lg:flex gap-[5px] text-[15px] lg:text-[20px] font-bold">
        <p class="motorcycle-motorcyclek">{{ motorcycle.motorcycle_make }}</p>
        <p class="motorcycle-motorcycleel">{{ motorcycle.motorcycle_model }}</p>
      </div>
      <!-- <div class="motorcycle-motorcyclee flex gap-[5px] text-[16px] mt-[5px]">
        <p class="motorcycle-motorcyclek">PureTech 130 EAT8 Allure Pack</p>
      </div> -->
      <div class="price flex gap-[5px] text-[11px] lg:text-[16px] mt-[5px]">
        €
        <p class="motorcycle-motorcyclece">{{ motorcycle.motorcycle_price }}</p>
      ...
      <div class="name-seller flex gap-[5px] mt-[20px]">
        <p class="name">{{ motorcycle.motorcycle_vendor }}</p>
        <p class="name">{{ user.user_gender }}</p>
        <p class="name">{{ user.user_first_name }}</p>      </div>
