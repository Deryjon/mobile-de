    ...
    <div class="price-tab flex flex-wrap items-center gap-[20px] lg:gap-[80px]">
      ...
      <div class="years-to dropdown-container mt-[27px]">
        <div class="input-container flex relative mt-[10px]">
          <input
            type="from"
            class="dropdown-input mark_input mark-select w-[150px] lg:w-[170px]  h-[35px] outline-none bg-white rounded-[10px] py-[6px] px-[10px] font-normal pr-[30px] text-[10px] lg:text-[12px]"
            placeholder="from"
            v-model="yearsTo"
