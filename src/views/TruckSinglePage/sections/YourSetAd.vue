  ...
  <v-container class="w-[1120px] flex justify-between pl-0 ml-[4px] relative" v-else>
    <div class="left flex flex-col gap-[20px] w-[700px] rounded-[4px]">
      <div class="img h-[500px]">
        <img :src="truck.truck_images_url" class="w-full h-full object-cover" alt="" />
      </div>
      <div class="basic-data bor flex flex-wrap gap-x-[40px] h-[180px] p-[20px]">
        <div class="mileage flex w-[186px] gap-[5px]">
          ...
          <div class="kilomet">
            ...
            <p class="font-bold">{{ truck.truck_kilometre }} km</p>
          </div>
        </div>
        <div class="registration flex w-[186px] gap-[5px]">
          ...
          <div class="kilomet">
            ...
            <p class="font-bold">{{ truck.truck_firt_date_year }}</p>
          </div>
        </div>
        ...
        <div class="power flex w-[186px]">
          ...
          <div class="kilomet">
            ...
            <p class="font-bold">{{ truck.truck_transmission }}</p>
          </div>
        </div>
        <div class="power flex w-[186px] gap-[5px]">
          <svg class="SvgIcon__1H1VO" width="40" height="40" viewBox="0 0 40 40" focusable="false" aria-hidden="true"
          ...
          <div class="kilomet">
            ...
            <p class="font-bold">{{ truck.truck_fuel_type }}</p>
          </div>
        </div>
      </div>
      <div class="technical-data bor p-[20px]">
       ...
       {{ truck.truck_category }}
          ...
          <div class="mileage flex justify-between">
            ...
            <p class="w-[288px] text-[14px]">{{ truck.truck_kilometre }} km</p>
          </div>
          ...
          <div class="cubic flex justify-between">
            <p class="w-[288px] text-[14px] font-semibold">Hydraulic Installation</p>
            <p class="w-[288px] text-[14px]">
          ...
          <div class="power flex justify-between">
            ...
            <p class="w-[288px] text-[14px]">{{ truck.truck_fuel_type }}</p>
          </div>
          <div class="cubic flex justify-between">
          ...
          <div class="availability flex justify-between">
            ...
            <p class="w-[288px] text-[14px]">{{ truck.truck_transmission }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[14px] font-semibold">
              First Registration
            </p>
            <p class="w-[288px] text-[14px]">{{ truck.truck_firt_date_year }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[14px] font-semibold">
             Cruise Control
            </p>
            <p class="w-[288px] text-[14px]">{{ truck.truck_cruise_control
 }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[14px] font-semibold">Condition</p>
            <p class="w-[288px] text-[14px]">{{ truck.truck_condition }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[14px] font-semibold">Colour</p>
            <p class="w-[288px] text-[14px]">{{ truck.truck_exterior_colour }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="description bor p-[20px]">
        ...
        <div class="phone mt-[10px]">
          <p class="phone text-[14px]">Phone: {{ truck.user_phone }}</p>
        </div>
        <div class="line mt-[10px]"></div>
    ...
    <div class="right mt-[25px]  bg-[#0000001f] w-[350px] h-[400px] rounded-[4px] p-[20px]"
      ...
      <div class="truck-name flex gap-[5px] text-[20px] font-bold">
