<template>
  <section class="basic-filter">
    <v-container class="max-w-[1140px]">
      <div
        class="relative filter xl:h-[800px] lg:h-[1000px] md:w-[700px] lg:w-[870px] xl:w-[1110px] bg-[#f5f5f5]  mx-auto mt-[5px] rounded p-[10px] lg:p-[27px]"
      >
        <h3 class="basic-title text-[25px] font-semibold"> {{ $t("message.filter_page.titles.technical") }}</h3>
