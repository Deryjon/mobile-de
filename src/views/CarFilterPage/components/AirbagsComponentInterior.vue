		...
		<div class="condition p-[20px]">
			...
			<div class="radios-type flex gap-[30px] mt-[10px]">
				...
				<label for="driver-airbag">
					...
					/>
					<span class="ml-[10px]">Driver Airbag </span>
				</label>
				<label for="front-airbag" @click="selectAirbag('Front')">
					...
					/>
					<span class="ml-[10px]">Front Airbags</span>
				</label>
				...
				<label for="side-airbag" @click="selectAirbag('FrontAndSide')">
					...
					/>
					<span class="ml-[10px]">Front and Side Airbags </span>
				</label>
				<label for="more-airbag" @click="selectAirbag('FrontAndSideMore')">
					...
					/>
					<span class="ml-[10px]">Front and Side and More Airbags </span>
				</label>
			</div>
		</div>
	</template>
