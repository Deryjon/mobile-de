  ...
  <div class="lg:pl-[20px]">
    <div class="price-tab flex items-center gap-[20px] lg:gap-[80px]">
      <div class="price dropdown-container">
        ...
        <ul v-if="priceOpen" class="dropdown-options w-[150px] text-[10px] lg:text-[12px]">
          <ul>
      ...
      <!-- <div class="price">
        ...
        <div class="marke_select_div relative mt-[10px]">
          <input
            placeholder="from"
            class="mark_input text-[14px] mark-select w-[150px] lg:w-[150px] xl:w-[200px] h-[35px] outline-none bg-white rounded-[10px] py-[6px] px-[10px] font-normal pr-[30px]"
            type="number" 
            pattern="\d*"
            v-model="price"
          />
      ...
      <div class="price-to dropdown-container mt-[27px]">
        ...
        <ul v-if="priceToOpen" class="dropdown-options w-[150px] text-[10px] lg:text-[12px]">
          <ul>
    ...
    <div class="registration flex items-center gap-[20px] lg:gap-[80px] mt-[10px] xl:mt-[50px]">
      <div class="years dropdown-container">
        ...
        <ul v-if="isOpen" class="dropdown-options w-[150px] text-[10px] lg:text-[12px]">
      ...
      <!-- <div>
        ...
        <div class="relative mt-[10px]">
          <input
            placeholder="from"
            class="no-spinner mark-select w-[150px] lg:w-[150px] xl:w-[200px] h-[35px] outline-none bg-white rounded-[10px] py-[6px] px-[10px] font-normal text-[10px] lg:text-[12px]"
            type="number"
            pattern="\d*"
            v-model="years"
          />
      ...
      <div class="years-to dropdown-container mt-[27px]">
        ...
        <ul v-if="isOpenYearsTo" class="dropdown-options w-[150px] text-[10px] lg:text-[12px]">
    ...
    <div class="kilometres mt-[20px] flex items-center gap-[20px] lg:gap-[80px]">
      ...
      <!-- <div class="">
        ...
        <div class="marke_select_div flex relative mt-[10px]">
          <input
            placeholder="from"
            id="inputYear"
            class="mark_input mark-select w-[150px] lg:w-[150px] xl:w-[200px] h-[35px] outline-none bg-white rounded-[10px] py-[6px] px-[10px] font-normal pr-[30px] text-[10px] lg:text-[12px]"
            type="number"
            pattern="\d*"
            v-model="killometres"
            readonly
      ...
      <div class="kilometer-to dropdown-container mt-[27px]">
        ...
        <ul v-if="isOpenKilometerTo" class="dropdown-options w-[150px] text-[10px] lg:text-[12px]">
    ...
    <div class="valid-until mt-[20px] flex flex-wrap items-center gap-x-[20px] lg:gap-x-[80px]">
      ...
      <div class="radius dropdown-container">
        ...
        <ul v-if="isOpenRadius" class="dropdown-options w-[150px] text-[10px] lg:text-[12px]">
...
export default {
  ...
  methods: {
    updateAgriculturalData() {
      (this.vehicleStore.vehicleData.vehicle_price_from =
        parseInt(this.price)),
        (this.vehicleStore.vehicleData.vehicle_price_to =
          parseInt(this.priceTo)),
        (this.vehicleStore.vehicleData.vehicle_construction_year_from =
          parseInt(this.inputValue)),
        (this.vehicleStore.vehicleData.vehicle_construction_year_to =
          parseInt(this.yearsTo)),
        (this.vehicleStore.vehicleData.vehicle_operating_hours_from =
          parseInt(this.inputKilometer)),
        (this.vehicleStore.vehicleData.vehicle_operating_hours_to =
          parseInt(this.killometresTo)),
        (this.vehicleStore.vehicleData.vehicle_country =
          this.selectedCountry),
        (this.vehicleStore.vehicleData.zipcode =
          this.zipCode),
        (this.vehicleStore.vehicleData.vehicle_radius =
          this.radius),
