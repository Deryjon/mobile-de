<template>
  <div class="mt-[10px] lg:p-[20px]">
    <h3>{{ $t("message.filter_page.features.interior") }}</h3>
    <div class="filter-cars flex flex-wrap gap-x-[30px] mt-[10px]">
      ...
      >
        <input
          ...
          @click="toggleShowCheckbox(0, 'Auxiliary heating')"
        />
        <svg
          class="icon"
      ...
      >
        <input
          ...
          @click="toggleShowCheckbox(2, 'Power Assisted Steering')"
        />
        <svg
          class="icon"
          xmlns="http://www.w3.org/2000/svg"
