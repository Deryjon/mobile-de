  ...
  <v-container class="lg:flex justify-between">
    <div class="left">
      <div class="tab-buttons mt-[0px]">
        <button class="login w-[240px] h-[54px]" @click="setActive('tab-1')" :class="{ active: isActive('tab-1') }">
          {{ $t("message.register.login") }}
        </button>

        <button class="forget w-[240px] h-[54px]" @click="setActive('tab-2')" :class="{ active: isActive('tab-2') }">
      ...
      <div class="tab-content bg-[#fff] w-[480px]">
        <div class="tab-panel" v-show="isActive('tab-1')">
          <div class="for-example">
            <v-sheet width="480" height="480" class="mx-auto shadow-md px-[40px] rounded-md">
              ...
              <v-form @submit.prevent="signUp">
                ...
                <p class="text-sm text-gray-600 font-medium underline cursor-pointer ml-1 mt-4">
        ...
        <div class="tab-panel" v-show="isActive('tab-2')">
          <div class="for-example">
            <v-sheet width="480" height="650" class="mx-auto shadow-md px-[40px] rounded-md">
