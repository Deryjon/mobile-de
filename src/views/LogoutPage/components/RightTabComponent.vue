<template>
  ...
  <div class="services mt-[20px]">
    <div class="service-1 flex items-center gap-[10px]">
      ...
      <p class="text-[16px]">{{ $t("message.register.parked") }}</p>
    </div>
    <div class="service-1 flex items-center gap-[10px] mt-[10px]">
      ...
      <p class="text-[16px]">{{ $t("message.register.searches") }}</p>
    </div>
    <div class="service-1 flex items-center gap-[10px] mt-[10px]">
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      <p class="text-[16px]">{{ $t("message.register.latest") }}</p>
    </div>
  </div>
</template>
<script></script>
