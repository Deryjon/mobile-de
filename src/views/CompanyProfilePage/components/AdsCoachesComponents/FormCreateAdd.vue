<template>
  <div class="">
    <div
      ...
      <div class="price-tab flex flex-wrap items-center gap-[10px] lg:gap-[30px]">
    ...
    <div class="mt-[15px] ">
      ...
      <div class="filter-cars flex flex-wrap gap-x-[30px] gap-y-[8px] mt-[20px]">
        ...
        <label
          ...
          {{ $t("message.filter_page.features.auxiliary") }}        </label>
        <label
          ...
          {{ $t("message.filter_page.features.cold") }}        </label>
        <label
          ...
          {{ $t("message.filter_page.features.drivers") }}        </label>
        <label
          ...
          {{ $t("message.filter_page.features.kitchen") }}
        </label>
        <label class="custom-checkbox custom-red flex gap-[10px] text-[14px] w-[210px] items-center h-[40px] pb-[20px]">
          ...
          {{ $t("message.filter_page.features.system") }}        </label>
        <label class="custom-checkbox custom-red flex gap-[10px] text-[14px] w-[210px] items-center h-[40px] pb-[20px]">
          ...
          {{ $t("message.filter_page.features.second") }}        </label>
        <label class="custom-checkbox custom-red flex gap-[10px] text-[14px] w-[210px] items-center h-[40px] pb-[20px]">
          ...
          {{ $t("message.filter_page.features.sleeper") }}        </label>
        <label class="custom-checkbox custom-red flex gap-[10px] text-[14px] w-[210px] items-center h-[40px] pb-[20px]">
...
export default {
  ...
  methods: {
    ...
    async addAdVans() {
      if (!this.selectedMark || !this.selectedModel || !this.selectedCondition || !this.selectedCategory || !this.activeTab || !this.price || !this.inputValue || !this.inputKilometer || !this.selectedCountry || !this.selectedFuel || !this.zipCode || !this.radius || !this.stickerEmission || !this.descriptionText || !this.selectedVendor) {
