<template>
  ...
  <div class="container">
    <div class="row-title">
      <span class="span-row-ttile">{{ $t("message.profile.hi") }}</span> Что
      желаете сделать сегодня?
    </div>
    <!-- ./row-title -->
    <div class="container-row">
      <div class="element">
        <div class="element-title">Начать новый поиск сейчас</div>
        <!-- /.element-title-->
        <div class="element-desc">
          <p>1.445.836 Автомобилей</p>
        </div>
        <!-- /.element-desc -->
    ...
    <div class="mycars-title">
      <h2 class="mycars-title-txt">Мои автомобили</h2>
    </div>
    ...
    <div class="contor">
      <div class="mycars-container">
        <div class="mycars-status-title">
          ...
          <span class="mycars-title-text"> Нет доступного автомобиля </span>
      ...
      <div class="mycars-status-tree-title">
        <span class="mycars-status-tree-title-txt"
          >Цифровой двойник вашего автомобиля</span
        >
      </div>
      <div class="mycars-tree-container">
        <div class="mycars-tree-info">
          ...
          <span class="mycars-tree-info-text">
            Никогда больше не забывайте о встрече: мы напомним вам о следующий
            встрече для осмотра или замены шин</span
          >
        </div>
        <div class="mycars-tree-info">
          <svg
          ...
          <span class="mycars-tree-info-text">
            Все данные об автомобили: здесь вы всегда найдете все важные
            данные!</span
          >
        </div>
        <div class="mycars-tree-info">
          ...
          <span class="mycars-tree-info-text">
            Текущая рыночная стоимость: стоит ли продавать? Здесь вы мгновенно
            получите рыночную стоимость</span
          >
        </div>
      </div>
    </div>
    ...
    <!-- MORE SERVICES -->
    <div class="mycars-title">
      <h2 class="mycars-title-txt">Больше услуг</h2>
    </div>

    <div class="more-row">
      <div class="more-element">
        <div class="more-txt">
          <div class="more-title">Что я могу позволить себе?</div>
          <div class="more-desc">
            <p>Нечего. Описание.</p>
          </div>
        </div>
