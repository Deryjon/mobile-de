<template>
  <div class="">
    ...
    <div class="fuel-add">
      ...
      <div class="mt-[30px]">
        <h3>            {{ $t("message.filter_page.features.interior") }}
</h3>
      ...
      <div class="mt-[30px]">
        <h3>            {{ $t("message.filter_page.features.extras") }}
</h3>
        <div class="filter-cars flex flex-wrap gap-x-[30px] mt-[10px]">
          <!-- cabrio -->
          <label
          ...
          <label
            class="custom-checkbox custom-gold flex gap-[10px] text-[14px] w-[206px] items-center h-[40px] pb-[20px]">
            <input type="checkbox" v-model="isCheckedCentral" @click="toggleShowCheckboxOthers(2, 'Central locking')" />
            <svg class="icon" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512" width="1em">
              <!-- Insert your SVG arrow icon here -->
    ...
    <div class="interior">
      ...
      <div>
        <div class="flex gap-[30px] justify-end">
          ...
          <button @click="addAdVehicle" class="bg-blue-500 rounded-[8px] p-[10px]">
