...
{{ $t("message.filter_page.motorhome.motorhome1") }}
          </label>
          <label class="custom-checkbox flex gap-[10px] text-[14px] items-center h-[40px] p-0 pb-[20px]">
            <input type="radio" :class="{
              'bg-transparent':
...
{{ $t("message.filter_page.motorhome.motorhome2") }}
...
{{ $t("message.filter_page.motorhome.motorhome3") }}
          </label>
          <label class="custom-checkbox flex gap-[10px] text-[14px] items-center h-[40px] p-0 pb-[20px]">
            <input type="radio" :class="{
...
{{ $t("message.filter_page.motorhome.motorhome4") }}
...
{{ $t("message.filter_page.motorhome.motorhome5") }}
...
{{ $t("message.filter_page.motorhome.motorhome6") }}
          ...
          <label class="custom-checkbox flex gap-4 text-[14px] items-center h-10 p-0 pb-4">
            ...
            <span class="text-[14px]">{{ $t("message.filter_page.motorhome.motorhome7") }}
</span>
          </label>
          ...
          <label class="custom-checkbox flex gap-4 items-center h-10 p-0 w-[200px] pb-4">
            ...
            <span class="text-[14px]">{{ $t("message.filter_page.motorhome.motorhome8") }}
</span>
          </label>
          <!-- small -->
          <label class="custom-checkbox flex gap-4 items-center h-10 p-0 pb-[20px]">
            ...
            <span class="text-[14px]">{{ $t("message.filter_page.motorhome.motorhome9") }}
</span>
          </label>
          <!-- sports -->
          <label class="custom-checkbox flex gap-3 items-center h-10 p-0 pb-[20px]">
            ...
            <span class="text-[14px]">{{ $t("message.filter_page.motorhome.motorhome10") }}
</span>
          </label>
        </div>
      </div>
    ...
    <div class="fuel-add">
      ...
      <div class="flex flex-wrap gap-x-[40px]">
        ...
        <div class="marke_select_div relative mt-[20px] lg:mt-[30px] w-[200px]">
          <h2 class="text-sm lg:text-[14px]">            {{ $t("message.filter_page.perm") }}
        ...
        <div class="marke_select_div relative mt-[20px] lg:mt-[50px] w-[200px]">
      ...
      <div>
        <div class="flex gap-[30px] justify-end">
          ...
          <button @click="addAdMotorbike" class="bg-blue-500 rounded-[8px] p-[10px]">
            {{ $t("message.ads_page.createad") }}          </button>
        </div>
      </div>
    </div>
  </div>
