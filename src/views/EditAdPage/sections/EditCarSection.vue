  ...
  <div class=" text-[12px] lg-text-[14px]" v-else >
    ...
    <div class="fuel-add">
      <div class="mt-[10px]">
        ...
        <div class="filter-cars flex flex-wrap gap-x-[60px] mt-[20px]">
          <!-- cabrio -->
          <label class="custom-checkbox p-0 flex gap-[2px] lg:gap-[10px] text-[12px] lg:text-[14px] items-center h-[40px] w-[140px] lg:w-[206px] pb-[20px]">
          ...
          <label class="custom-checkbox flex gap-[2px] lg:gap-[10px] text-[12px] lg:text-[14px] items-center h-[40px] w-[140px] lg:w-[206px] pb-[20px] p-0">
            <input type="radio" v-model="selectedFuel" :class="{
          ...
          <!-- estate -->
          <label class="custom-checkbox p-0 flex gap-4 text-[12px] lg:text-[14px] items-center h-10 w-[140px] lg:w-[206px] pb-4">
            <input type="radio" v-model="selectedFuel" :class="{
    ...
    <div class="filter-cars flex flex-wrap gap-x-[30px] mt-[10px]">
      ...
      >
        ...
        >
          <!-- Insert your SVG arrow icon here -->
          <path
            v-if="isCheckedAdaptiveLighting"
            fill="#ffffff"
            d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"
          />
        </svg>
      ...
      >
        ...
        >
          <!-- Insert your SVG arrow icon here -->
          <path
            v-if="isCheckedSportsSuspension"
            fill="#ffffff"
            d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"
          />
        </svg>
      ...
      >
        ...
        >
          <!-- Insert your SVG arrow icon here -->
          <path
            v-if="isCheckedLEDRunningLights"
            fill="#ffffff"
            d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"
          />
        </svg>
      ...
      >
        ...
        >
          <!-- Insert your SVG arrow icon here -->
          <path
            v-if="isCheckedBixenonHeadlights"
            fill="#ffffff"
            d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"
          />
        </svg>
      ...
      >
        ...
        >
          <!-- Insert your SVG arrow icon here -->
          <path
            v-if="isCheckedNightVisionAssist"
            fill="#ffffff"
            d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"
          />
        </svg>
      ...
      >
        ...
        >
          <!-- Insert your SVG arrow icon here -->
          <path
            v-if="isCheckedHeadlightWasherSystem"
            fill="#ffffff"
            d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"
          />
        </svg>
    ...
    <div class="filter-cars flex flex-wrap gap-x-[30px] gap-y-[8px] mt-[20px]">
      ...
      >
        <input
          type="checkbox"
          v-model="isCheckedUSBport"
          @click="toggleShowCheckboxExtras(7, 'USB port')"
        />
        <svg
          class="icon"
          xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <input
          type="checkbox"
          v-model="isCheckedCdPlayer"
          @click="toggleShowCheckboxExtras(7, 'CD player')"
        />
        <svg
          class="icon"
          xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <input
          type="checkbox"
          v-model="isCheckedHeadupDisplay"
      ...
      >
        <input
          type="checkbox"
          v-model="isCheckedOnBoardComputer"
      ...
      >
        <input
          type="checkbox"
          v-model="isCheckedDABradio"
          @click="toggleShowCheckboxExtras(7, 'DAB radio')"
        />
        <svg
          class="icon"
          xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <input
          type="checkbox"
          v-model="isCheckedPaddleShifters"
      ...
      >
        <input
          type="checkbox"
          v-model="isCheckedWinterPackage"
      ...
      >
        <input
          type="checkbox"
          v-model="isCheckedDigitalCockpit"
      ...
      >
        <input
          type="checkbox"
          v-model="isCheckedPassengerSeat"
