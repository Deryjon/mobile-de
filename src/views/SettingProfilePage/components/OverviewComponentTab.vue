<template>
  ...
  <div class="container">
    ...
    <div class="contor">
      ...
      <div class="mycars-tree-container">
        ...
        <div class="mycars-tree-info">
          ...
          <span class="mycars-tree-info-text">
            {{ $t("message.profile.currentMarket") }}
          </span>
        </div>
      </div>
    </div>
    ...
    <!-- MORE SERVICES -->
    <div class="mycars-title">
      {{ $t("message.profile.services") }}
      <h2 class="mycars-title-txt"></h2>
    </div>

    <div class="more-row">
      <div class="more-element">
        <div class="more-txt">
          {{ $t("message.profile.afford") }}
          <div class="more-title"></div>
          <div class="more-desc">
            {{ $t("message.profile.descr") }}
            <p></p>
          </div>
        </div>
        <div class="more-icon">
