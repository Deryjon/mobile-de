<template>
  <div class="flex flex-wrap gap-[40px] justify-between mt-[20px] p-[5px]">
    <div v-for="motorcycle in motorcycles" :key="motorcycle.motorcycle_id" :data-motorcycle-id="motorcycle.id"
      ...
      <div class="price text-[15px] lg:text-[18px] font-semibold">
        <p class="price mx-auto w-[100px]">€{{ motorcycle.motorcycle_price }}</p>
        <div class="flex gap-[10px] justify-center md:justify-end md:mt-[90px] lg:mt-[200px]">
          ...
          <button @click="editAdCar(motorcycle.motorcycle_id)"
