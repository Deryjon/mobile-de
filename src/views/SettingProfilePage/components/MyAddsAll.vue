<template>
  <div class="flex flex-wrap gap-[40px] justify-between mt-[20px]">
    ...
    >
      <div class="img w-[400px] h-[120px] mr-[20px]">
				<img :src="car.car_images_url[0]" alt="">
			</div>
          ...
          Doors
			...
			<div class="price text-[18px] font-semibold">
				...
				<div class="flex gap-[10px] justify-end mt-[200px]">
					<button class="flex items-center gap-[5px] bg-red-500 rounded-[4px] text-[14px] p-[8px] px-[20px]" @click="deleteAdCar(car.car_id)">
