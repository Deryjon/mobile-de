<template>
  <div class="set lg:p-[40px] w-[210px] xs:w-full lg:w-[750px] xl:w-[900px]">
    <div class="add " v-if="createAdd">
      <div class="ads">
        <p class="car-text font-bold text-[18px] md:text-[25px] lg:text-[30px]">            {{ $t("message.ads_page.coachead") }}
</p>
      </div>
      <div class="">
				<p class="car-text font-bold text-[14px] md:text-[16px] lg:text-[20px] mt-[20px]">            {{ $t("message.ads_page.createnew") }}
</p>
      ...
      >
        ...
        <p class="text-center w-[310px] mx-auto">
