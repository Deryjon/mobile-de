<template>
  ...
  <div class="basic-add w-[210px] xs:w-full lg:w-[700px] xl:w-[850px] text-[12px] lg:text-[14px] pt-[15px] p-[5px] lg:p-0">
    ...
    <div class="mark w-[200px]">
      <div class="relative mt-2">
        <h2 class="text-sm lg:text-[14px]">{{ $t("message.filter_page.category") }}</h2>
        <select
  ...
  <div class="fuel-add">
    ...
    >
      <div class="">
        <h2 class="text-sm lg:text-[14px] mt-2">{{ $t("message.filter_page.loadcap") }}</h2>
...
export default {
  ...
  methods: {
    ...
    addAdTrucks() {
      ...
      formData.append("trailer_features", this.selectedOthers);
