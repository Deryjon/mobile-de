<template>
  <main>
    ...
    <section
      ...
      <v-container>
        <div
          class="search relative w-[350px] sm:w-[600px] lg:w-[800px] xl:w-[1000px] bg-[#f5f5f5] h-[240px] mt-[200px] mx-auto flex"
        >
          <div class="tabs">
          ...
          <div class="tab-content mt-16 absolute left-[9`0px] sm:left-[120px]">
