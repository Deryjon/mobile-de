        ...
        >
          <div class="tabs">
            <div class="nav-tabs flex lg:flex-col">
              ...
              >
                <svg id="tabs_img" width="40" height="20" viewBox="0 0 96 48"
								class="mx-auto"
								>
                  <path
              ...
              >
                <svg width="40" height="20" viewBox="0 0 96 48" fill="none"
								class="mx-auto"
								>
              ...
              <div
                ...
                :class="{ active: isActive('tab-3') }"
							...
							<svg width="40" height="20" viewBox="0 0 96 48" fill="none" class="mx-auto">
                  <path
...
>
            ...
            <button
              class="filter-btn bg-[#d3d3d3] py-[12px]  sm:py-[17.1px] lg:py-[17.5px]  sm:px-[11.3px] lg:px-[20px] hover:bg-[#beb5b5]"
            >
              New
            </button>
            <button
            ...
            <select
              class="filter-btn bg-[#d3d3d3] py-[12px]  sm:py-[17.1px] lg:py-[17.5px] w-[154px] sm:px-[11.3px] lg:px-[20px] hover:bg-[#beb5b5] cursor-pointer"
            >
          ...
          <div class="filter-btns hidden lg:flex  h-[30px] lg:h-[60px] ">
            ...
            >
              ...
              <option value="">Right hand drive</option>
						...
						<span
              class="arrow w-[7px] h-[7px] absolute sm:right-[0%] lg:right-[210px] xl:right-[420px] top-[25px]"
            ></span>
            <button
...
export default defineComponent({
  ...
  components: { Tab1Component, Tab2Component, Tab3Component, Tab4Components, HeaderLayoutVue },
});
