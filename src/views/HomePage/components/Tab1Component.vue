<template>
  <div class="for-example">
    <div class="filters-selects flex gap-[50px] lg:gap-[40px] xl:gap-x-[80px]">
      <div class="relative">
    ...
    <div
      class="top sm:flex flex-wrap  gap-x-[50px]  w-[250px] sm:w-[450px] md:w-[550px] lg:w-[850px] xl:w-[950px] items-center  lg:gap-x-[40px] xl:gap-x-[80px]">
      <div class="mark">
    ...
    <div
      class="bottom-all lg:flex w-[300px] lg:w-[800px] sm:w-[350px] items-center gap-[80px] lg:gap-[40px] xl:gap-x-[80px]">
      <div>
        <h2 class="mt-2 text-sm lg:text-[14px]">
      ...
      <div class="tab-content">
        <div
          class="bottom tab-panel sm:flex flex-wrap items-center lg:gap-[40px] xl:gap-x-[80px] sm:w-[450px] md:w-[550px] lg:w-[600px] xl:w-[700px] sm:gap-x-[50px]">
