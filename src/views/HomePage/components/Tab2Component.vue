  ...
  <li key="2045" @click="selectOption('2045')">2045</li>
    ...
    <div class="bottom-all lg:flex w-[300px] lg:w-[800px] sm:w-[350px] items-center gap-[80px] lg:gap-[40px] xl:gap-x-[80px]">
      ...
      <div class="tab-content">
        <div class="bottom tab-panel sm:flex flex-wrap items-center lg:gap-[40px] xl:gap-x-[80px] sm:w-[450px] md:w-[550px] lg:w-[600px] xl:w-[700px] sm:gap-x-[50px]" >
          ...
          <FilterBtn :to="{ name: 'car-filter' }" @click="goMotorbikeList">
...
export default {
  ...
  methods: {
    ...
    updateMotorbikeData() {
      ...
      motorcycleStore.motorcycleData.motorcycle_firt_date_year_from = this.inputValue;
      ...
      motorcycleStore.motorcycleData.city = this.cityName;
