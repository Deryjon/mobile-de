<template>
  <div class="for-example">
    <div class="cars lg:flex  mt-2">
      <div class="cars_cars flex gap-[20px] sm:gap-[100px]">
        <div class="cars_cars_car2 mt-[10px]">
          <img
            alt="Agricultural"
      ...
      <div class="cars_cars flex gap-[20px] sm:gap-[100px]">
        <div class="cars_cars _car2 mt-[9px]">
          <img
            alt="Agricultural"
      ...
      <div class="cars_cars flex gap-[20px] sm:gap-[100px]">
        <div class="cars_cars flex_car2 mt-[9px]">
          <img
            alt="Agricultural"
      ...
      <div class="cars_cars flex ">
        <div class="cars_car2 mt-[9px]">
          <img
            alt="Agricultural"
