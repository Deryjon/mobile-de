<template>
  <div class="mt-[10px] lg:p-[20px]">
    ...
    <div class="flex flex-wrap items-center gap-[20px] lg:gap-[40px]">
      <div class="length dropdown-container">
        <h2 class="mt-2 text-sm lg:text-[14px] w-[150px]">Permissible (GVW)</h2>
      ...
      <div class="number dropdown-container">
        <h2 class="mt-2 text-sm lg:text-[14px] w-[150px]">Load capacity </h2>
        <div class="input-container flex relative mt-[10px]">
          <input type="from"
            class="dropdown-input mark_input mark-select w-[150px] lg:w-[150px] xl:w-[200px] h-[35px] outline-none bg-white rounded-[10px] py-[6px] px-[10px] font-normal pr-[30px] text-[10px] lg:text-[12px]"
...
export default {
  ...
  methods: {
    updateSemiTrailerData() {
      ...
      const semitrailerData = semitrailerStore.semitrailerData;
      semitrailerData.trailer_axles = this.axles;
      semitrailerData.trailer_gvw_from = this.lengthGVW;
      semitrailerData.trailer_gvw_to = this.lengthGVWTo;
      semitrailerData.trailer_load_capacity_from = this.numberBunks;
      semitrailerData.trailer_load_capacity_to = this.numberBunksTo;
