...
import ExteriorColorComponent from "./components/ExteriorColorComponent.vue";
export default {
  components: { PathLink, FilterTitle, FilterBtn,   FuelComponent, ExteriorColorComponent },
};
</script>
<style scoped></style>
<style>
