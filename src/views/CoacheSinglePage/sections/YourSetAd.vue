  ...
  <v-container class="max-w-[1140px] md:flex gap-[5px] justify-between pl-0 ml-[4px] relative" v-else>
    ...
    <div
      ...
      <div class="flex gap-[20px]">
        ...
        <div v-if="!userIcon">
          <img :src="coache.user_image_url" class="w-[100px] h-[100px] object-cover" />
        </div>
    ...
    <div class="left flex flex-col gap-[20px] w-full md:max-w-[600px] lg:max-w-[700px]  rounded-[4px] mt-[10px]">
      ...
      <div class="basic-data bor flex flex-wrap gap-[5px]  justify-between lg:h-[180px] p-[20px] md:mt-[100px] lg:mt-[20px]">
        <div class="mileage flex w-[186px] gap-[5px]">
          ...
          <div class="kilomet">
            ...
            <p class="text-[12px] font-medium lg:font-bold">{{ coache.coache_kilometre }} km</p>
          </div>
        </div>
        ...
        <div class="power flex w-[186px]">
          ...
          <div class="kilomet">
            ...
            <p class="text-[12px] font-medium lg:font-bold">{{ coache.coache_transmission }}</p>
          </div>
        </div>
        <div class="power flex w-[186px] gap-[5px]">
          <svg class="SvgIcon__1H1VO" width="40" height="40" viewBox="0 0 40 40" focusable="false" aria-hidden="true"
          ...
          <div class="kilomet">
            ...
            <p class="text-[12px] font-medium lg:font-bold">{{ coache.coache_fuel_type }}</p>
          </div>
        </div>
      </div>
      <div class="technical-data bor p-[20px]">
        ...
        <div class="td-box mt-[20px] flex flex-col gap-[10px] lg:gap-[20px]">
          ...
          <div class="mileage flex justify-between">
            ...
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ coache.coache_kilometre }} km</p>
          </div>
          <div class="cubic flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">{{ $t("message.single_page.numberseats") }}</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">
          ...
          <div class="cubic flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">{{ $t("message.single_page.programme") }}</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">
          ...
          <div class="power flex justify-between">
            ...
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ coache.coache_fuel_type }}</p>
          </div>
          <div class="availability flex justify-between">
            ...
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ coache.coache_transmission }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">
              {{ $t("message.single_page.first") }}
            </p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ coache.coache_firt_date_year }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">
              {{ $t("message.single_page.cruise") }}
            </p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ coache.coache_cruise_control
            }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">{{ $t("message.single_page.condition") }}</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ coache.coache_condition }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">{{ $t("message.single_page.sticker") }}</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ coache.coache_emissions_sticker }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">{{ $t("message.single_page.class") }}</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ coache.coache_emission_class }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">{{ $t("message.single_page.color") }}</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ coache.coache_exterior_colour }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="description bor p-[20px]">
        ...
        <div class="line mt-[10px]"></div>
        <div class="flex flex-wrap mt-[20px] gap-[20px] justify-between text-[12px] lg:text-[14px]">
          <P class=""> {{ coache.coache_describtion }} </P>
        </div>
      </div>
      <div class="description bor p-[20px]">
        ...
        <div class="phone mt-[10px]">
          <p class="phone text-[11px] lg:text-[14px]">{{ $t("message.single_page.phone") }}: {{ coache.user_phone }}</p>
        </div>
      </div>
    </div>
    <div
