  ...
  <v-container class="w-[1120px] flex justify-between pl-0 ml-[4px]" v-else>
    <section class="w-full settings relative bg-[#0000001f] p-[40px]">
      <div class="flex flex-wrap gap-[40px] justify-between mt-[20px]">
        <div v-for="car in cars" class="card bor flex justify-between w-full h-[320px] p-[20px] cursor-pointer"
          @click="goToSinglePageAd(car.car_id)">
          <div class="img bor w-[350px] h-[260px] m-0">

            <img class="w-[100%] h-full" :src="car.car_images_url" />
          </div>
          <div class="text h-[260px]">
