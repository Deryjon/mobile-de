        ...
        >
          ...
          >
            <img
              ...
              :src="forklift.forklift_images_url"
            />
          </div>
          <div class="text lg:h-[260px]">
            ...
            <div class="forklift-coachey hidden lg:flex gap-[5px] text-[14px]">
...
export default {
  ...
  methods: {
    ...
    fetchAds() {
      ...
      http
        .post(`/forklifts/list?limit=100&offset=0`, forkliftData)
        .then((res) => {
