  ...
  methods: {
    updateTrailerData() {
      ...
      (trailerStore.trailerData.trailer_price_from =
        parseInt(this.price)),
      (trailerStore.trailerData.trailer_price_to =
        parseInt(this.priceTo)),
      (trailerStore.trailerData.trailer_firt_date_year_from =
        parseInt(this.inputValue)),
      (trailerStore.trailerData.trailer_firt_date_year_to =
        parseInt(this.yearsTo)),
      (trailerStore.trailerData.trailer_kilometre_from =
        parseInt(this.inputKilometer)),
      (trailerStore.trailerData.trailer_kilometre_to =
        parseInt(this.killometresTo)),
      (trailerStore.trailerData.trailer_country =
        this.selectedCountry),
      (trailerStore.trailerData.trailer_city_zipcode =
        this.zipCode),
      (trailerStore.trailerData.trailer_radius =
        this.radius),
