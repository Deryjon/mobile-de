  ...
  <v-container class="w-[1120px] flex justify-between pl-0 ml-[4px] relative">
    <div class="left flex flex-col gap-[20px] w-[700px] rounded-[4px]">
      <div class="img h-[500px]">
        <img :src="construction.machine_images_url" class="w-full h-full object-cover" alt="" />
      </div>
      <div class="basic-data bor flex flex-wrap justify-between h-[180px] p-[20px]">
        <div class="mileage flex w-[186px] gap-[5px]">
          ...
          <div class="kilomet">
            ...
            <p class="font-bold">{{ construction.machine_mileage }} km</p>
          </div>
        </div>
        <div class="registration flex w-[186px] gap-[5px]">
          ...
          <div class="kilomet">
            ...
            <p class="font-bold">{{ construction.machine_firt_date_year }}</p>
          </div>
        </div>
        ...
        <div class="power flex w-[186px]">
          ...
          <div class="kilomet">
            ...
            <p class="font-bold">{{ construction.machine_transmission }}</p>
          </div>
        </div>
        <div class="power flex w-[186px] gap-[5px]">
          <svg class="SvgIcon__1H1VO" width="40" height="40" viewBox="0 0 40 40" focusable="false" aria-hidden="true"
          ...
          <div class="kilomet">
            ...
            <p class="font-bold">{{ construction.machine_previous_owners }}</p>
          </div>
        </div>
        <div class="power flex w-[186px] gap-[5px]">
          <svg class="SvgIcon__1H1VO" width="40" height="40" viewBox="0 0 40 40" focusable="false" aria-hidden="true"
          ...
          <div class="kilomet">
            ...
            <p class="font-bold">{{ construction.machine_fuel_type }}</p>
          </div>
        </div>
      </div>
      <div class="technical-data bor p-[20px]">
        ...
        <div class="td-box mt-[20px] flex flex-col gap-[20px]">
          ...
          <div class="power flex justify-between">
            ...
            <p class="w-[288px] text-[14px]">{{ construction.machine_fuel_type }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[14px] font-semibold">Number of Seats</p>
            <p class="w-[288px] text-[14px]">{{ construction.machine_number_seats }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[14px] font-semibold">Door Count</p>
            <p class="w-[288px] text-[14px]">{{ construction.machine_number_door }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[14px] font-semibold">Gearbox</p>
            <p class="w-[288px] text-[14px]">{{ construction.machine_transmission }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[14px] font-semibold">Emission Class</p>
            <p class="w-[288px] text-[14px]">{{ construction.machine_emission_class }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[14px] font-semibold">Emissions Sticker</p>
            <p class="w-[288px] text-[14px]">{{ construction.machine_emissions_sticker }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[14px] font-semibold">
              First Registration
            </p>
            <p class="w-[288px] text-[14px]">{{ construction.machine_firt_date_year }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[14px] font-semibold">HU</p>
            <p class="w-[288px] text-[14px]">{{ construction.machine_hu_valid_until }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[14px] font-semibold">Colour</p>
            <p class="w-[288px] text-[14px]">{{ construction.machine_exterior_colour }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="description bor p-[20px]">
        ...
        <div class="flex flex-wrap mt-[20px] gap-[20px] justify-between text-[14px]">
          <P class="title"> {{ construction.machine_description }} </P>
        </div>
      </div>
      <div class="description bor p-[20px]">
      ...
      <div class="description bor p-[20px]">
        ...
        <div class="phone mt-[10px]">
          <p class="phone text-[14px]">Phone: {{ construction.coachhone }}</p>
        </div>
        <div class="line mt-[10px]"></div>
    ...
    <div class="right mt-[50px]  bg-[#0000001f] w-[350px] h-[400px] rounded-[4px] p-[20px]"
      ...
      <div class="construction-name flex gap-[5px] text-[20px] font-bold">
...
export default {
  ...
  methods: {
    ...
    fetchAds() {
      ...
      http.get(`/construction/${this.carId}`).then((res) => {
