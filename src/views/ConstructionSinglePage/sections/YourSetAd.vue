<template>
  ...
  <v-container class="max-w-[1140px] md:flex gap-[5px] justify-between pl-0 ml-[4px] relative" v-else>
    <div class="relative md:hidden  h-[230px] lg:h-[500px] w-full lg:w-[700px]">
      ...
      <p class="mt-[-30px]">{{ formatDate(construction.machine_ad_create_at) }}</p>
    ...
    <div
      ...
      <div class="flex gap-[20px]">
        ...
        <div class="text">
          ...
          <div class="name-seller flex flex-wrap gap-[5px] mt-[10px] font-semibold text-[14px]">
            ...
            <p class="name text-[14px]">Nr: {{ company.company_address_nr }} {{ construction.user_address_nr }}</p>
      ...
      <div class="name-seller mt-[15px] font-semibold text-[12px]">
        <p class="name">{{ $t("message.single_page.phone") }}: {{ company.company_country_code }} {{
          company.company_phone_number }}   {{ construction.user_country_code }}  {{ construction.user_phone_number}}</p>
      </div>
    ...
    <div class="left flex flex-col gap-[20px] w-full md:max-w-[600px] lg:max-w-[700px]  rounded-[4px] mt-[10px]">
      <div class=" relative hidden md:block  h-[230px] lg:h-[400px] w-full lg:max-w-[700px]">
        ...
        <p class="mt-[-24px]">{{ formatDate(construction.machine_ad_create_at) }}</p>
      </div>
      <div class="basic-data bor flex flex-wrap gap-[5px] justify-between  p-[20px] md:mt-[90px] lg:mt-[20px]">
        <div class="registration flex w-[186px] gap-[5px]">
          ...
          <div class="kilomet">
            ...
            <p class="text-[12px] font-medium lg:font-bold">{{ construction.machine_firt_date }}</p>
          </div>
        </div>
        <div class="power flex w-[186px] gap-[5px]">
          ...
          <div class="kilomet">
            ...
            <p class="text-[12px] font-medium lg:font-bold">{{ construction.machine_operating_hours }}</p>
          </div>
        </div>
      </div>
      <div class="technical-data bor p-[20px]">
        ...
        <div class="td-box mt-[20px] flex flex-col gap-[20px]">
          ...
          <div class="availability flex justify-between">
            ...
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ construction.machine_firt_date }}</p>
          </div>
          <div class="availability flex justify-between">
      ...
      <div class="features bor p-[20px]">
        ...
        <div class="flex flex-wrap mt-[20px] gap-[20px] justify-between text-[11px] lg:text-[14px] font-semibold">
          <div v-for="item in construction.machine_features" class="flex justify-between w-[297px]">
            <p class="">{{ item }} </p>
      ...
      company.company_phone_number }} {{ construction.user_country_code }}    {{ construction.user_phone_number}}
          </p>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    fetchAds() {
      ...
      http.get(`/constructions/${this.carId}`).then((res) => {
        ...
        this.link = this.construction.machine_vide_link;
        ...
        this.profileImg = this.construction.user_image_url || this.company.company_image_url
