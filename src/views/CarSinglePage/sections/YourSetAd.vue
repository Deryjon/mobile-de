<template>
  <v-container class="w-[1120px] flex justify-between pl-0 ml-[4px]">
    <div class="left flex flex-col gap-[20px] w-[700px] rounded-[4px]">
      ...
      <div class="technical-data  bor p-[20px]">
        ...
        <div class="td-box mt-[20px] flex flex-col gap-[20px]">
          ...
          <div class="cubic flex justify-between">
            <p class="w-[288px] text-[14px] font-semibold">Cubic Capacity
</p>
            <p class="w-[288px] text-[14px]">1,199 ccm
</p>
          </div>
          <div class="power flex justify-between">
            <p class="w-[288px] text-[14px] font-semibold">Power
</p>
            <p class="w-[288px] text-[14px]">96 kW (131 Hp)
      ...
      <div class="features h-[330px] bg-blue-500">
				<div class="btn show-more mx-auto cursor-pointer">
						<p class="show text-[#e04b00] text-[14px]  underline">Show all</p>
					</div>
			</div>
