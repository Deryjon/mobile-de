<template>
  ...
  <v-container class="max-w-[1140px] md:flex gap-[5px] justify-between pl-0 ml-[4px] relative" v-else>
    ...
    <div
      class="right h-[550px] lg:h-[500p`x]  mt-[45px] hidden md:mt-[5px] md:block bg-[#0000001f] w-[130px] lg:w-[250px] xl:w-[350px] rounded-[4px] p-[5px] lg:p-[20px]"
      :class="{
  ...
  top: isScrolled ? '0' : 'auto',
      ...
      <div class="lg:flex items-center gap-[20px] ">
        ...
        <div class="text">
          ...
          <div class="name-seller flex flex-wrap gap-[5px] mt-[20px] font-semibold text-[14px]">
            <p class="name">{{ car.car_vendor }}</p>
            <p class="name">{{ car.user_gender }}</p>
            <p class="name">{{ car.user_first_name }}</p>
            <p class="name text-[14px]">{{ company.company_name }}</p>
