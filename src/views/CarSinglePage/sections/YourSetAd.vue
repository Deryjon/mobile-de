    ...
    <div class="left flex flex-col gap-[20px] w-full md:max-w-[600px] lg:max-w-[700px]  rounded-[4px] mt-[10px]">
      ...
      <div class="basic-data bor flex flex-wrap gap-[5px] justify-between    p-[20px] md:mt-[60px] lg:mt-0">
        <div class="mileage flex w-[186px] gap-[5px]">
          ...
          <div class="kilomet">
            ...
            <p class="text-[12px] font-medium lg:font-bold">{{ car.car_mileage }} km</p>
          </div>
        </div>
        <div class="registration flex w-[186px] gap-[5px]">
          ...
          <div class="kilomet">
            ...
            <p class="text-[12px] font-medium lg:font-bold">{{ car.car_firt_date_year }}</p>
          </div>
        </div>
        ...
        <div class="power flex w-[186px]">
          ...
          <div class="kilomet">
            ...
            <p class="text-[12px] font-medium lg:font-bold">{{ car.car_transmission }}</p>
          </div>
        </div>
        <div class="power flex w-[186px] gap-[5px]">
          <svg class="SvgIcon__1H1VO" width="40" height="40" viewBox="0 0 40 40" focusable="false" aria-hidden="true"
          ...
          <div class="kilomet">
            ...
            <p class="text-[12px] font-medium lg:font-bold">{{ car.car_previous_owners }}</p>
          </div>
        </div>
        <div class="power flex w-[186px] gap-[5px]">
          <svg class="SvgIcon__1H1VO" width="40" height="40" viewBox="0 0 40 40" focusable="false" aria-hidden="true"
          ...
          <div class="kilomet">
            ...
            <p class="text-[12px] font-medium lg:font-bold">{{ car.car_fuel_type }}</p>
          </div>
        </div>
      </div>
      <div class="technical-data bor p-[20px]">
        ...
        <div class="td-box mt-[20px] flex flex-col gap-[10px] lg:gap-[20px]">
          ...
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">Origin</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ car.car_programme }}</p>
          </div>
          <div class="mileage flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">Mileage</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ car.car_mileage }} km</p>
          </div>
          ...
          <div class="power flex justify-between">
            ...
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ car.car_fuel_type }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">Number of Seats</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ car.car_number_seats }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">Door Count</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ car.car_number_door }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">Gearbox</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ car.car_transmission }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">Emission Class</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ car.car_emission_class }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">Emissions Sticker</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ car.car_emissions_sticker }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">
              First Registration
            </p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ car.car_firt_date_year }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">HU</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ car.car_hu_valid_until }}</p>
          </div>
          <div class="availability flex justify-between">
            <p class="w-[288px] text-[11px] lg:text-[14px] font-semibold">Colour</p>
            <p class="w-[288px] text-[11px] lg:text-[14px]">{{ car.car_exterior_colour }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="description bor p-[20px]">
        ...
        <div class="phone mt-[10px]">
          <p class="phone text-[11px] lg:text-[14px]">Phone: {{ car.user_phone }}</p>
        </div>
        <div class="line mt-[10px]"></div>
